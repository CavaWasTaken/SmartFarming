...
class NutrientManagement(MqttSubscriber):
    ...
    def on_message(self, client, userdata, msg):
        with open("../logs/NutrientManagement.log", "a") as log_file:  # print all the messages received on a log file
            ...
            if message["bn"] == "greenhouse_1/sensors/NPK":   # check the topic of the message
                npk = message["v"]
                if npk < 100:
            ...
            elif message["bn"] == "greenhouse_1/sensors/Ph":
                ph = message["v"]
                if ph < 7:
            ...
            elif message["bn"] == "greenhouse_1/schedules/fertilization":
                log_file.write(f"Received fertilization schedule: {message["e"]}\n")

if __name__ == "__main__":
    broker = "mqtt.eclipseprojects.io"  # broker address
    port = 1883
    topics = ["greenhouse_1/sensors/NPK", "greenhouse_1/sensors/Ph", "greenhouse_1/sensors/SoilMoisture", "greenhouse_1/schedules/fertilization"]    # nutrient values
