...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!greenhouseId || !greenhouseName || !greenhouseLocation) {
        alert("No greenhouse selected. Please select a greenhouse to access this page.");
    ...
    .then(config => {
        ...
        return fetch(`${catalog_url}/get_greenhouse_configurations?${queryParams}`, {
            method: "GET",
    ...
    .then(data => {
        ...
        sensors.forEach(sensor => {
            ...
            if (sensor.type === "NPK") {
                minThreshold = sensor.threshold.N.min + ", " + sensor.threshold.P.min + ", " + sensor.threshold.K.min;
                maxThreshold = sensor.threshold.N.max + ", " + sensor.threshold.P.max + ", " + sensor.threshold.K.max;
            }else {
            ...
            card.innerHTML = `
                ...
                <button class="primary-text", id="set-threshold-button">
                    Set Threshold
                </button>
                <div class="details">
                    <div class="rating">
        ...
        // const devicesCards = document.querySelector(".device-cards");
        ...
        //     card.innerHTML = `
        //         <div class="card-img">
        //             <svg fill="#e1c61b" viewBox="-5.5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>light</title> <path d="M11.875 6v2.469c0 0.844-0.375 1.25-1.156 1.25s-1.156-0.406-1.156-1.25v-2.469c0-0.813 0.375-1.219 1.156-1.219s1.156 0.406 1.156 1.219zM14.219 9.25l1.438-2.031c0.469-0.625 1.063-0.75 1.656-0.313s0.656 1 0.188 1.688l-1.438 2c-0.469 0.688-1.031 0.75-1.656 0.313-0.594-0.438-0.656-0.969-0.188-1.656zM5.781 7.25l1.469 2c0.469 0.688 0.406 1.219-0.219 1.656-0.594 0.469-1.156 0.375-1.625-0.313l-1.469-2c-0.469-0.688-0.406-1.219 0.219-1.656 0.594-0.469 1.156-0.375 1.625 0.313zM10...."></path> </g></svg>
        //         </div>
        //         <div class="desc">
        //             <h6 class="primary-text">
        //                 ${device.name}
        //             </h6>
        //         </div>
        //         <button class="primary-text", id="check-status-button">
        //             Check Status
        //         </button>
        //         <div class="details">
        //             <div class="rating">
        ...
        //             </div>
        //         </div>`;
        //     devicesCards.appendChild(card);
        // });
        // const plantsCards = document.querySelector(".plant-cards");
        ...
        //             </h6>
        //         </div>
        //         <button class="primary-text", id="remove-plant-button">
        //             Remove plant
        //         </button>
        //         <div class="details">
        //             <div class="rating">
