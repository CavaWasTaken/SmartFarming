...
expected_value = {} # dictionary of the next expected value for each sensor used by the microservice
timers = {} # dictionary of the timer for each sensor used by the microservice
tresholds = {}  # dictionary of tresholds for each sensor used by the microservice
domains = {}    # dictionary of domains for each sensor used by the microservice    
